    ...
    <footer style={{ background: "#0b0b12", borderTop: "1px solid rgba(255,240,214,0.05)" }}>
      ...
      <div style={{
        ...
        <span style={{
          ...
          Part of the TÃ¡raDome Entertainment Group
        </span>
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{
            ...
            An African-owned music institution â€” building legacy, one release at a time.
          </p>
      ...
      <div style={{
        ...
        <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "11px", color: "rgba(255,240,214,0.16)" }}>
          Â© {new Date().getFullYear()} TÃ¡raDome Entertainment Group. All rights reserved.
        </span>
